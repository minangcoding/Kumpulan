...
const DetailNews = () => {
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
      ...
      {/* 1. INFO PENULIS & TOMBOL SHARE (FITUR BARU) */}
      <div className="flex flex-col md:flex-row md:items-center justify-between py-6 border-y border-gray-100 mb-10 gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Tombol X (Twitter) */}
          <button className="w-10 h-10 rounded-full bg-gray-100 text-gray-700 flex items-center justify-center hover:bg-gray-900 hover:text-white transition-all">
          ...
          {/* Tombol Copy Link */}
          <button className="w-10 h-10 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all" title="Salin Tautan">
